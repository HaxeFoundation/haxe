...
@:coreType abstract UInt64 {
	...
	**/
	...
	@:op(A + B) inline function _add(u:UInt64):UInt64
		return this.add(u);

	@:op(A - B) inline function _sub(u:UInt64):UInt64
		return this.sub(u);

	@:op(A * B) inline function _mul(u:UInt64):UInt64
		return this.mul(u);

	@:op(A / B) inline function _div(u:UInt64):UInt64
		return this.div(u);

	@:op(A & B) inline function _logand(u:UInt64):UInt64
		return this.logand(u);

	@:op(A | B) inline function _logor(u:UInt64):UInt64
		return this.logor(u);

	@:op(A ^ B) inline function _logxor(u:UInt64):UInt64
		return this.logxor(u);

	@:op(A << B) inline function _shift_left(i:Int):UInt64
		return this.shift_left(i);

	@:op(A >> B) inline function _shift_right(i:Int):UInt64
		return this.shift_right(i);

	@:op(~A) inline function _lognot():UInt64
		return this.lognot();

	@:op(A != B) static inline function eq(a:UInt64, b:UInt64):Bool
		return compare(a, b) != 0;

	@:op(A == B) static inline function ne(a:UInt64, b:UInt64):Bool
		return compare(a, b) == 0;

	@:op(A < B) static inline function lt(a:UInt64, b:UInt64):Bool
		return compare(a, b) < 0;

	@:op(A > B) static inline function gt(a:UInt64, b:UInt64):Bool
		return compare(a, b) > 0;

	@:op(A <= B) static inline function lte(a:UInt64, b:UInt64):Bool
		return compare(a, b) <= 0;

	@:op(A >= B) static inline function gte(a:UInt64, b:UInt64):Bool
		return compare(a, b) >= 0;
}
