...
extern class Security {
	...
	static var disableAVM1Loading(get,set) : Bool;
	static var exactSettings(get,set) : Bool;
	@:require(flash11) static var pageDomain(get,never) : String;
	static var sandboxType(get,never) : String;
