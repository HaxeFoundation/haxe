...
@:require(flash10) extern class Matrix3D {
	...
	@:require(flash11) function copyRawDataFrom(vector : flash.Vector<Float>, index : UInt = 0u32, transpose : Bool = false) : Void;
	@:require(flash11) function copyRawDataTo(vector : flash.Vector<Float>, index : UInt = 0u32, transpose : Bool = false) : Void;
