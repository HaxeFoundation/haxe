...
@:require(flash10_1) extern class GeolocationEvent extends Event {
	var altitude(get,set) : Float;
	var heading(get,set) : Float;
	var horizontalAccuracy(get,set) : Float;
	var latitude(get,set) : Float;
	var longitude(get,set) : Float;
	var speed(get,set) : Float;
	var timestamp(get,set) : Float;
	var verticalAccuracy(get,set) : Float;
