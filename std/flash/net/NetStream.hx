...
extern class NetStream extends flash.events.EventDispatcher {
	var audioCodec(get,never) : UInt;
	@:require(flash10_1) var audioReliable(get,set) : Bool;
	@:require(flash10_1) var audioSampleAccess(get,set) : Bool;
	@:require(flash10_1) var backBufferLength(get,never) : Float;
	@:require(flash10_1) var backBufferTime(get,set) : Float;
	var bufferLength(get,never) : Float;
	var bufferTime(get,set) : Float;
	@:require(flash10_1) var bufferTimeMax(get,set) : Float;
	...
	@:require(flash10_1) var dataReliable(get,set) : Bool;
	var decodedFrames(get,never) : UInt;
	@:require(flash10) var farID(get,never) : String;
	@:require(flash10) var farNonce(get,never) : String;
	@:require(flash10_1) var inBufferSeek(get,set) : Bool;
	@:require(flash10) var info(get,never) : NetStreamInfo;
	var liveDelay(get,never) : Float;
	@:require(flash10) var maxPauseBufferTime(get,set) : Float;
	@:require(flash10_1) var multicastAvailabilitySendToAll(get,set) : Bool;
	@:require(flash10_1) var multicastAvailabilityUpdatePeriod(get,set) : Float;
	@:require(flash10_1) var multicastFetchPeriod(get,set) : Float;
	@:require(flash10_1) var multicastInfo(get,never) : NetStreamMulticastInfo;
	@:require(flash10_1) var multicastPushNeighborLimit(get,set) : Float;
	@:require(flash10_1) var multicastRelayMarginDuration(get,set) : Float;
	@:require(flash10_1) var multicastWindowDuration(get,set) : Float;
	@:require(flash10) var nearNonce(get,never) : String;
	var objectEncoding(get,never) : UInt;
	@:require(flash10) var peerStreams(get,never) : Array<Dynamic>;
	var soundTransform(get,set) : flash.media.SoundTransform;
	var time(get,never) : Float;
	@:require(flash11) var useHardwareDecoder(get,set) : Bool;
	@:require(flash11_3) var useJitterBuffer(get,set) : Bool;
	var videoCodec(get,never) : UInt;
	@:require(flash10_1) var videoReliable(get,set) : Bool;
	@:require(flash10_1) var videoSampleAccess(get,set) : Bool;
	@:require(flash11) var videoStreamSettings(get,set) : flash.media.VideoStreamSettings;
