...
elseif _G.bit32 or pcall(require, 'bit32') then
  ...
  _hx_bit.bnot = function(...) return _hx_c.__lua_Boot.clampInt32(_hx_bit_raw.bnot(...)) end
  _hx_bit.bxor = function(...) return _hx_c.__lua_Boot.clampInt32(_hx_bit_raw.bxor(...)) end
  -- see https://github.com/HaxeFoundation/haxe/issues/8849
  _hx_bit.bor = function(...) return _hx_c.__lua_Boot.clampInt32(_hx_bit_raw.bor(...)) end
  _hx_bit.band = function(...) return _hx_c.__lua_Boot.clampInt32(_hx_bit_raw.band(...)) end
  _hx_bit.arshift = function(...) return _hx_c.__lua_Boot.clampInt32(_hx_bit_raw.arshift(...)) end
  _hx_bit.lshift = function(...) return _hx_c.__lua_Boot.clampInt32(_hx_bit_raw.lshift(...)) end
