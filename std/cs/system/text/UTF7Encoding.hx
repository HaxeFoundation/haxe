...
extern class UTF7Encoding extends cs.system.text.Encoding {
	@:overload(function():Void {})
	function new(allowOptionals:Bool):Void;
	/**
	 ...
	 * @return A  that converts a UTF-7 encoded sequence of bytes into a sequence of
	 * Unicode characters.
	 */
	 ...
	 * @return A  that converts a sequence of Unicode characters into a UTF-7 encoded
	 * sequence of bytes.
	 */
