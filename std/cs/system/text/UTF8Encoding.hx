...
extern class UTF8Encoding extends cs.system.text.Encoding {
	@:overload(function():Void {})
	@:overload(function(encoderShouldEmitUTF8Identifier:Bool):Void {})
	function new(encoderShouldEmitUTF8Identifier:Bool, throwOnInvalidBytes:Bool):Void;
	/**
	 ...
	 * @return A decoder that converts a UTF-8 encoded sequence of bytes into a
	 * sequence of Unicode characters.
	 */
	 ...
	 * @return A  that converts a sequence of Unicode characters into a UTF-8 encoded
	 * sequence of bytes.
	 */
	...
	/**
	 * Returns a Unicode byte order mark encoded in UTF-8 format, if the  encoding
	 * object is configured to supply one.
	 * @return A byte array containing the Unicode byte order mark, if the  encoding
	 * object is configured to supply one. Otherwise, this method returns a zero-length
	 * byte array.
	 */
