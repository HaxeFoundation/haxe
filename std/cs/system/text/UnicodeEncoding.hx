...
extern class UnicodeEncoding extends cs.system.text.Encoding {
	/** Represents the Unicode character size in bytes. This field is a constant. */
	static var CharSize(default, never):Int;
	@:overload(function():Void {})
	@:overload(function(bigEndian:Bool, byteOrderMark:Bool):Void {})
	function new(bigEndian:Bool, byteOrderMark:Bool, throwOnInvalidBytes:Bool):Void;
	/**
	 ...
	 * @return A  that converts a UTF-16 encoded sequence of bytes into a sequence of
	 * Unicode characters.
	 */
	 ...
	 * @return A  object that converts a sequence of Unicode characters into a UTF-16
	 * encoded sequence of bytes.
	 */
	 ...
	 * @param count The number of bytes to decode.
	 * @return A  object containing the results of decoding the specified sequence of
	 * bytes.
	 */
