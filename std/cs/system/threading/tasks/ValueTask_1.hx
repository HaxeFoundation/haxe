...
@:native("System.Threading.Tasks.ValueTask`1")
extern class ValueTask_1<TResult> extends cs.system.ValueType {
	/**
	...
	@:overload(function(task:cs.system.threading.tasks.Task_1<TResult>):Void {})
	@:overload(function(result:TResult):Void {})
	function new(source:cs.system.threading.tasks.sources.IValueTaskSource_1<TResult>, token:cs.Int16):Void;
	/**
	 ...
	 */
	static function op_Equality<TResult>(left:cs.system.threading.tasks.ValueTask_1<TResult>, right:cs.system.threading.tasks.ValueTask_1<TResult>):Bool;
	/**
	 ...
	 */
	static function op_Inequality<TResult>(left:cs.system.threading.tasks.ValueTask_1<TResult>, right:cs.system.threading.tasks.ValueTask_1<TResult>):Bool;
	/**
	 * Retrieves a  object that represents this .
	 * @return The  object that is wrapped in this  if one exists, or a new  object
	 * that represents the result.
	 */
	function AsTask():cs.system.threading.tasks.Task_1<TResult>;
	/**
	 ...
	 */
	function ConfigureAwait(continueOnCapturedContext:Bool):cs.system.runtime.compilerservices.ConfiguredValueTaskAwaitable_1<TResult>;
	 ...
	 */
	function Equals(other:cs.system.threading.tasks.ValueTask_1<TResult>):Bool;
	/**
	 * Creates an awaiter for this value.
	 * @return The awaiter.
	 */
	function GetAwaiter():cs.system.runtime.compilerservices.ValueTaskAwaiter_1<TResult>;
	/**
	 ...
	 */
	function Preserve():cs.system.threading.tasks.ValueTask_1<TResult>;
