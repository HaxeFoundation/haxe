...
extern class JapaneseCalendar extends cs.system.globalization.Calendar {
	function new():Void;
	/**
	 ...
	 * @param year A year.
	 * @param era An era.
	 * @return The return value is always 0 because the  type does not support the
	 ...
	 * @param year An integer that represents the year.
	 * @param era An integer that represents the era.
	 * @return The return value is always 12.
	 */
	 ...
	 * @param year An integer (usually two digits) that represents the year to convert.
