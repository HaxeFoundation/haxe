...
extern class KoreanCalendar extends cs.system.globalization.Calendar {
	/** Represents the current era. This field is constant. */
	static var KoreanEra(default, never):Int;
	function new():Void;
	/**
	 ...
	 * week.
	 * @return A 1-based integer that represents the week of the year that includes the
	 * date in the  parameter.
	 */
