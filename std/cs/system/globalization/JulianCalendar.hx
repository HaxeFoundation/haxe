...
extern class JulianCalendar extends cs.system.globalization.Calendar {
	/** Represents the current era. This field is constant. */
	static var JulianEra(default, never):Int;
	function new():Void;
	/**
	 ...
	 * and era. Alternatively, this method returns zero if the calendar does not
	 * support a leap month, or if  and  do not specify a leap year.
	 */
