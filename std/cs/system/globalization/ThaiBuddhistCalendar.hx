...
@:native("System.Globalization.ThaiBuddhistCalendar")
extern class ThaiBuddhistCalendar extends cs.system.globalization.Calendar {
	/** Represents the current era. This field is constant. */
	static var ThaiBuddhistEra(default, never):Int;
	function new():Void;
	/**
	 ...
	 * week.
	 * @return A 1-based positive integer that represents the week of the year that
	 * includes the date in the  parameter.
	 */
