...
extern class HijriCalendar extends cs.system.globalization.Calendar {
	/** Represents the current era. This field is constant. */
	static var HijriEra(default, never):Int;
	/**
	 * Gets or sets the number of days to add or subtract from the calendar to
	 * accommodate the variances in the start and the end of Ramadan and to accommodate
	 * the date difference between countries/regions.
	 * @return An integer from -2 to 2 that represents the number of days to add or
	 * subtract from the calendar.
	 */
	var HijriAdjustment(default, default):Int;
	function new():Void;
	/**
	 * Returns a  that is the specified number of months away from the specified .
	 * @param time The  to add months to.
	 ...
	 * @param time The  to add years to.
	 ...
	 * @param time The  to read.
	 * @return An integer from 1 to 355 that represents the day of the year in the
	 * specified .
	 */
	 ...
	 * @return Always 0 because the  type does not support the notion of a leap month.
	 */
	 ...
	 * @param year An integer that represents the year.
	 * @param era An integer that represents the era.
	 * @return The number of months in the specified year and era.
	 */
