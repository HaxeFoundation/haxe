...
@:native("System.ValueTuple`1")
extern class ValueTuple_1<T1> extends cs.system.ValueType {
	var Item1:T1;
	 ...
	 */
	function CompareTo(other:cs.system.ValueTuple_1<T1>):Int;
	 ...
	 */
	function Equals(other:cs.system.ValueTuple_1<T1>):Bool;
	/**
