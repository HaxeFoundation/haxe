...
extern class UnicastIPAddressInformationCollection {
	/**
	...
	@:native("get_Item")
	function get_Item(index0:Int):cs.system.net.networkinformation.UnicastIPAddressInformation;
	/**
	 ...
	 */
	function Add(address:cs.system.net.networkinformation.UnicastIPAddressInformation):Void;
	/** Throws a  because this operation is not supported for this collection. */
	function Clear():Void;
	/**
	 ...
	 */
	function Contains(address:cs.system.net.networkinformation.UnicastIPAddressInformation):Bool;
	/**
	 ...
	 */
	function CopyTo(array:cs.NativeArray<cs.system.net.networkinformation.UnicastIPAddressInformation>, offset:Int):Void;
	/**
	 ...
	 */
	function GetEnumerator():cs.system.collections.generic.IEnumerator<cs.system.net.networkinformation.UnicastIPAddressInformation>;
	/**
	 ...
	 */
	function Remove(address:cs.system.net.networkinformation.UnicastIPAddressInformation):Bool;
}
