...
extern class IPAddressInformationCollection {
	/**
	...
	@:native("get_Item")
	function get_Item(index0:Int):cs.system.net.networkinformation.IPAddressInformation;
	/**
	 ...
	 */
	function Add(address:cs.system.net.networkinformation.IPAddressInformation):Void;
	/** Throws a  because this operation is not supported for this collection. */
	function Clear():Void;
	/**
	 ...
	 */
	function Contains(address:cs.system.net.networkinformation.IPAddressInformation):Bool;
	/**
	 ...
	 */
	function CopyTo(array:cs.NativeArray<cs.system.net.networkinformation.IPAddressInformation>, offset:Int):Void;
	/**
	 ...
	 */
	function GetEnumerator():cs.system.collections.generic.IEnumerator<cs.system.net.networkinformation.IPAddressInformation>;
	/**
	 * Throws a  because this operation is not supported for this collection.
	 * @param address The object to be removed.
	 * @return Always throws a .
	 */
	function Remove(address:cs.system.net.networkinformation.IPAddressInformation):Bool;
}
