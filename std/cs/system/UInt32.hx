...
@:native("System.UInt32")
extern class UInt32 extends cs.system.ValueType {
	/** Represents the largest possible value of . This field is constant. */
	static var MaxValue(default, never):cs.UInt;
	/** Represents the smallest possible value of . This field is constant. */
	static var MinValue(default, never):cs.UInt;
	@:overload(function(s:String):cs.UInt {})
	@:overload(function(s:String, style:cs.system.globalization.NumberStyles):cs.UInt {})
	@:overload(function(s:String, provider:cs.system.IFormatProvider):cs.UInt {})
	@:overload(function(s:cs.system.ReadOnlySpan<cs.Char16>, ?style:cs.system.globalization.NumberStyles, ?provider:cs.system.IFormatProvider):cs.UInt {})
	/**
	 * @param s 
	 * @param style 
	 * @param provider 
	 */
	static function Parse(s:String, style:cs.system.globalization.NumberStyles, provider:cs.system.IFormatProvider):cs.UInt;
	@:overload(function(s:cs.system.ReadOnlySpan<cs.Char16>, result:cs.Ref<cs.UInt>):Bool {})
	@:overload(function(s:String, result:cs.Ref<cs.UInt>):Bool {})
	@:overload(function(s:cs.system.ReadOnlySpan<cs.Char16>, style:cs.system.globalization.NumberStyles, provider:cs.system.IFormatProvider, result:cs.Ref<cs.UInt>):Bool {})
	/**
	 * @param s 
	 * @param style 
	 * @param provider 
	 * @param result 
	 */
	static function TryParse(s:String, style:cs.system.globalization.NumberStyles, provider:cs.system.IFormatProvider, result:cs.Ref<cs.UInt>):Bool;
	 ...
	 * .
	 */
	function CompareTo(value:cs.UInt):Int;
	 ...
	 * .
	 */
	function Equals(obj:cs.UInt):Bool;
	/**
