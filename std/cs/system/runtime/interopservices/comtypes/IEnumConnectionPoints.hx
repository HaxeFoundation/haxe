...
extern interface IEnumConnectionPoints {
	 ...
	 */
	function Clone(ppenum:cs.Ref<cs.system.runtime.interopservices.comtypes.IEnumConnectionPoints>):Void;
	/**
	 ...
	 */
	function Next(celt:Int, rgelt:cs.NativeArray<cs.system.runtime.interopservices.comtypes.IConnectionPoint>, pceltFetched:cs.system.IntPtr):Int;
