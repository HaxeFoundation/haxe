...
extern interface IEnumFORMATETC {
	 ...
	 */
	function Clone(newEnum:cs.Ref<cs.system.runtime.interopservices.comtypes.IEnumFORMATETC>):Void;
	/**
	 ...
	 * number of references enumerated in . This parameter is passed uninitialized.
	 * @return if the  parameter equals the  parameter; otherwise, .
	 */
	function Next(celt:Int, rgelt:cs.NativeArray<cs.system.runtime.interopservices.comtypes.FORMATETC>, pceltFetched:cs.NativeArray<Int>):Int;
	/**
