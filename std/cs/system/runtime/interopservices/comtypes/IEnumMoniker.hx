...
extern interface IEnumMoniker {
	 ...
	 */
	function Clone(ppenum:cs.Ref<cs.system.runtime.interopservices.comtypes.IEnumMoniker>):Void;
	/**
	 * Retrieves a specified number of items in the enumeration sequence.
	 * @param celt The number of monikers to return in .
	 * @param rgelt When this method returns, contains a reference to the enumerated
	 * monikers. This parameter is passed uninitialized.
	 * @param pceltFetched When this method returns, contains a reference to the actual
	 * number of monikers enumerated in .
	 * @return if the  parameter equals the  parameter; otherwise, .
	 */
	function Next(celt:Int, rgelt:cs.NativeArray<cs.system.runtime.interopservices.comtypes.IMoniker>, pceltFetched:cs.system.IntPtr):Int;
