...
extern interface IEnumConnections {
	 ...
	 */
	function Clone(ppenum:cs.Ref<cs.system.runtime.interopservices.comtypes.IEnumConnections>):Void;
	/**
	 * Retrieves a specified number of items in the enumeration sequence.
	 * @param celt The number of  structures to return in .
	 * @param rgelt When this method returns, contains a reference to the enumerated
	 * connections. This parameter is passed uninitialized.
	 * @param pceltFetched When this method returns, contains a reference to the actual
	 * number of connections enumerated in .
	 * @return if the  parameter equals the  parameter; otherwise, .
	 */
	function Next(celt:Int, rgelt:cs.NativeArray<cs.system.runtime.interopservices.comtypes.CONNECTDATA>, pceltFetched:cs.system.IntPtr):Int;
