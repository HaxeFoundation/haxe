...
@:native("System.Runtime.CompilerServices.AsyncTaskMethodBuilder")
extern class AsyncTaskMethodBuilder extends cs.system.ValueType {
	/**
	 ...
	 */
	static function Create():cs.system.runtime.compilerservices.AsyncTaskMethodBuilder;
	/**
