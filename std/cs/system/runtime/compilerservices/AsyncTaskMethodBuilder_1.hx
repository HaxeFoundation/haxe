...
@:native("System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1")
extern class AsyncTaskMethodBuilder_1<TResult> extends cs.system.ValueType {
	/**
	 ...
	 */
	static function Create<TResult>():cs.system.runtime.compilerservices.AsyncTaskMethodBuilder_1<TResult>;
	/**
