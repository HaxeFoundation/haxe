...
@:native("System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder")
extern class AsyncValueTaskMethodBuilder extends cs.system.ValueType {
	/**
	 * Gets the task for this builder.
	 * @return The task for this builder.
	 */
	var Task(default, never):cs.system.threading.tasks.ValueTask;
	/**
	 * Creates an instance of the  struct.
	 * @return The initialized instance.
	 */
	static function Create():cs.system.runtime.compilerservices.AsyncValueTaskMethodBuilder;
	/**
