...
@:native("System.Dynamic.DeleteIndexBinder")
extern class DeleteIndexBinder extends cs.system.dynamic.DynamicMetaObjectBinder {
	/**
	 ...
	 * @param target The target of the dynamic delete index operation.
	 * @param args An array of arguments of the dynamic delete index operation.
	...
	/**
	 * Performs the binding of the dynamic delete index operation if the target dynamic
	 * object cannot bind.
	 * @param target The target of the dynamic delete index operation.
	 * @param indexes The arguments of the dynamic delete index operation.
	 * @return The  representing the result of the binding.
	 */
	function FallbackDeleteIndex(target:cs.system.dynamic.DynamicMetaObject, indexes:cs.NativeArray<cs.system.dynamic.DynamicMetaObject>, errorSuggestion:cs.system.dynamic.DynamicMetaObject):cs.system.dynamic.DynamicMetaObject;
}
