...
@:native("System.Dynamic.CreateInstanceBinder")
extern class CreateInstanceBinder extends cs.system.dynamic.DynamicMetaObjectBinder {
	/**
	 ...
	 * @param target The target of the dynamic create operation.
	 * @param args An array of arguments of the dynamic create operation.
	...
	/**
	 * Performs the binding of the dynamic create operation if the target dynamic
	 * object cannot bind.
	 * @param target The target of the dynamic create operation.
	 * @param args The arguments of the dynamic create operation.
	 * @return The  representing the result of the binding.
	 */
	function FallbackCreateInstance(target:cs.system.dynamic.DynamicMetaObject, args:cs.NativeArray<cs.system.dynamic.DynamicMetaObject>, errorSuggestion:cs.system.dynamic.DynamicMetaObject):cs.system.dynamic.DynamicMetaObject;
}
