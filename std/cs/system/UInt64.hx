...
extern class UInt64 extends cs.system.ValueType {
	/** Represents the largest possible value of . This field is constant. */
	static var MaxValue(default, never):cs.UInt64;
	/** Represents the smallest possible value of . This field is constant. */
	static var MinValue(default, never):cs.UInt64;
	@:overload(function(s:String):cs.UInt64 {})
	@:overload(function(s:String, style:cs.system.globalization.NumberStyles):cs.UInt64 {})
	@:overload(function(s:String, provider:cs.system.IFormatProvider):cs.UInt64 {})
	@:overload(function(s:cs.system.ReadOnlySpan<cs.Char16>, ?style:cs.system.globalization.NumberStyles, ?provider:cs.system.IFormatProvider):cs.UInt64 {})
	/**
	 * @param s 
	 * @param style 
	 * @param provider 
	 */
	static function Parse(s:String, style:cs.system.globalization.NumberStyles, provider:cs.system.IFormatProvider):cs.UInt64;
	@:overload(function(s:cs.system.ReadOnlySpan<cs.Char16>, result:cs.Ref<cs.UInt64>):Bool {})
	@:overload(function(s:String, result:cs.Ref<cs.UInt64>):Bool {})
	@:overload(function(s:cs.system.ReadOnlySpan<cs.Char16>, style:cs.system.globalization.NumberStyles, provider:cs.system.IFormatProvider, result:cs.Ref<cs.UInt64>):Bool {})
	/**
	 * @param s 
	 * @param style 
	 * @param provider 
	 * @param result 
	 */
	static function TryParse(s:String, style:cs.system.globalization.NumberStyles, provider:cs.system.IFormatProvider, result:cs.Ref<cs.UInt64>):Bool;
	 ...
	 * .
	 */
	function CompareTo(value:cs.UInt64):Int;
	 ...
	 * .
	 */
	function Equals(obj:cs.UInt64):Bool;
	/**
