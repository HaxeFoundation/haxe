...
extern class HybridDictionary {
	/**
	 * Gets the number of key/value pairs contained in the .
	 * @return The number of key/value pairs contained in the . Retrieving the value of
	...
	function new(initialSize:Int, caseInsensitive:Bool):Void;
	/**
