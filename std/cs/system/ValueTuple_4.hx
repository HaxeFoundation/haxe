...
@:native("System.ValueTuple`4")
extern class ValueTuple_4<T1, T2, T3, T4> extends cs.system.ValueType {
	var Item1:T1;
	var Item2:T2;
	var Item3:T3;
	var Item4:T4;
	 ...
	 */
	function CompareTo(other:cs.system.ValueTuple_4<T1, T2, T3, T4>):Int;
	 ...
	 */
	function Equals(other:cs.system.ValueTuple_4<T1, T2, T3, T4>):Bool;
	/**
