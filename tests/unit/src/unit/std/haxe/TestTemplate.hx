package unit.std.haxe;

class TestTemplate extends unit.Test {
	public function test() {
		...
		eq(output, "My name is <strong>John</strong> and I'm <em>33</em> years old.");

		// not existent
		var output2 = tpl.execute( { } );
		eq(output2, "My name is <strong>null</strong> and I'm <em>null</em> years old.");

		// globals
		haxe.Template.globals = { name : "John", age : 33 };
		var output2 = tpl.execute( { } );
		eq(output2, "My name is <strong>John</strong> and I'm <em>33</em> years old.");
