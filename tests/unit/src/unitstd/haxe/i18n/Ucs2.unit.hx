...
// charAt
wrap("foo1bar").charAt(0) == wrap("f");
wrap("foo1bar").charAt(1) == wrap("o");
wrap("foo1bar").charAt(2) == wrap("o");
wrap("foo1bar").charAt(3) == wrap("1");
wrap("foo1bar").charAt(4) == wrap("b");
wrap("foo1bar").charAt(5) == wrap("a");
wrap("foo1bar").charAt(6) == wrap("r");
wrap("foo1bar").charAt(7) == wrap("");
wrap("foo1bar").charAt( -1) == wrap("");
wrap("").charAt(0) == wrap("");
wrap("").charAt(1) == wrap("");
wrap("").charAt( -1) == wrap("");
