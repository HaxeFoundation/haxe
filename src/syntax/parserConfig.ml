...
let file_parser_config com file =
	...
	Parser.create_config com.defines in_display in_display_file com.display.dms_kind com.part_scope.parser_state.was_auto_triggered (Some com.part_scope.parser_state.special_identifier_files)
