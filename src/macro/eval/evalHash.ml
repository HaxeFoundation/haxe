...
let key_eval_vm_NativeThreadExit = hash "eval.vm.NativeThreadExit"
...
let key_sys_net_Semaphore = hash "sys.thread.Semaphore"
let key_sys_net_Condition = hash "sys.thread.Condition"
