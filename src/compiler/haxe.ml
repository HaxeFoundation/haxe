...
let parsed_args = Args.parse_args_new sctx args in
Server.process sctx request_scope Compiler.HighLevel.entry (ServerCommunication.Communication.create_stdio ()) args parsed_args;